...
/*   Updated: 2023/01/16 16:51:43 by foctavia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm( AForm const &form )
{
	...
	{
		form.execute(*this);
		std::cout << this->_name << GREEN(" executed ") << form.getName() << std::endl;
	}
	catch(AForm::AFormException &e)
	{
		std::cerr << this->_name << RED(" couldn't execute form ") << form.getName()
			<< " because " << e.what() << std::endl;
	}
}
